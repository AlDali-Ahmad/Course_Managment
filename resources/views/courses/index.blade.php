    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <a id="btn-submit" href="/courses/create"  class="btn btn-outline-secondary">{{__('Create Course')}}</a><br>
            </div>
            <div class="row g-4 justify-content-center">
                ...
                @endforeach
                <a href="/coursetypes" type="submit" class="btn btn-primary">{{__('Course Gategore')}}</a>
            </div>
        </div>
    </div>
@endsection
